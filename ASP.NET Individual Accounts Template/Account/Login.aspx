<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ASP.NET_Individual_Accounts_Template.Account.Login" Async="true" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="Email"
                                CssClass="text-danger" ErrorMessage="The email fields is required." />
                        </div>
                    </div>
                    <div class="row">
